...
The QIR adaptive profile acts as a bridge between today's hardware and the sophisticated systems of the future. For example, QIR adds many of the capabilities required to move from physical qubits to logically-encoded qubits. It adds many of the instructions developers want to use to encode the logical operations, moving our community closer to a standard-based interoperable quantum-classical IR of the fault-tolerant future.
...
QIR is making steady progress with stable 1.0 version release including base and adaptive profile specifications. Quantinuum is leading the way in practical adoption of the latest QIR capabilities and working with other Alliance members to define the future of the standard. Much more to come!
